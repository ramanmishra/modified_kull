<template>
  <div>
    ...
    <div class='selection-area' v-if="src || arrayBuffer" ref="selectionArea">
...
export default {
  name: 'AnnotatorWithoutAnnotation',
  components: {
    AreaSelect,
    PDF,
    SelectionPreview
  ...
  methods: {
    ...
    start: function (event) {
      ...
      console.log(this.coords.xa, '    ', this.coords.xb, '   ', this.coords.ya, '    ', this.coords.yb)
    },
    end: function (event) {
      event.stopPropagation()
      event.preventDefault()
